 ...
 */
abstract class AbstractManagerAccessExtension implements QueryCollectionExtensionInterface, QueryItemExtensionInterface
{

    public const FIRST_ELEMENT_ARRAY = 0;

    public const AFFECTED_ROLES = [
        User::ROLE_OWNER
    ];
    ...
    protected function isFiltering($operationName, $resourceClass): bool
    {
        ...
        return !$this->apply($operationName) ||
            count(array_intersect(self::AFFECTED_ROLES, $token->getRoleNames())) ||
